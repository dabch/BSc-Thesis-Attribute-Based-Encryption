...
\usepackage{lmodern} % workaround for BBB Font issue
...
\lstset{%
  ...
  autogobble,
  frame=single,
  keywordstyle=\bfseries\color{TUMBlau},
  stringstyle=\color{TUMGruen},
  language=Rust
}

\defbeamertemplate{itemize item}{arrow}{\textcolor{TUMOrange}{$\rightarrow$}}