...
This chapter introduces \acrlong{abe} and the relevant mathematical background for implementing it. For further reference, please refer to % TODO
...
\begin{figure}
    ...
    \begin{subfigure}[t]{0.45\textwidth}
        ...
        \begin{tikzpicture}[actor/.style={draw, minimum width=1.5cm}]
            ...
            \draw[->] (kgc) edge pic [right=1.1cm, above=0.3cm, scale=0.05, blue] {key} node [right] {\{$PK$, $\textcolor{blue}{k_A}$\}} (b);
...
\subsection{Formal definition of an \acrshort{abe} Scheme}\label{sec:definition-es}
