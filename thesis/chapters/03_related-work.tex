...
Their choice of elliptic curves, however, only provides a security level of 80 bits (the 224-bit MNT curve from the PBC library is closer to a 128-bit \gls{security-level}~\cite{akinyele_self-protecting_2010}).
...
They use the pairing library \emph{RELIC Toolkit}\footnote{\url{https://github.com/relic-toolkit/relic}} at a security level of 128 bits and evaluate a C implementation of the \acrshort{cp-abe} scheme in \cite{waters_ciphertext-policy_2011}.
