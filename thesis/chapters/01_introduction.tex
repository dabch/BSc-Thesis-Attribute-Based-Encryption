...
Its approach of combining \glspl{attribute} and \glslink{access-policy}{policies} describing characteristics of admissible decryption keys is closer to traditional notions of access control (e.g. RBAC) than conventional encryption~\cite{bethencourt_ciphertext-policy_2007}.
