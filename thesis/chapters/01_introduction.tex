...
Its approach of combining \glspl{attribute} and \gls{access-policy}{policies} describing admissible attribute combinations is closer to traditional notions of access control (e.g. RBAC)~\cite{bethencourt_ciphertext-policy_2007}. % TODO find citation
...
Compared to standard cryptgraphy, most \acrshortpl{abes} demand even more resources.
