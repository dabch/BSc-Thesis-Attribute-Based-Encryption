...
\newglossaryentry{crate}{
  name={crate},
  description={bundle of Rust code that groups some related functionality together. Can be published to \url{https://crates.io} to share with other developers},
}
