...
\newglossaryentry{msp}{name={monotone span program},description={monotone span program}}
\newglossaryentry{lsss}{name={LSSS},description={linear secret sharing scheme}}
