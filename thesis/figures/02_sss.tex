\begin{figure}
    \centering
    \begin{tikzpicture}
        \begin{axis} [axis lines=center, xlabel=$x$, ylabel=$p(x)$, ymin=0, height=0.35\textheight, width=0.65\textwidth]
          ...
          \end{axis}
    \end{tikzpicture}
    \caption[Plot of $(4,5)$-threshold secret sharing scheme]{
        Example for a $(4,5)$-threshold scheme with $s=8$ and $p(x) = 8 + 7x - 6x^2 + x^3$.
