\begin{figure}[h]
    ...
    \begin{subfigure}[h]{0.49\textwidth}
        \begin{tikzpicture}
            \begin{axis}[
                title={Timing of GPSW on the laptop},
                width=\textwidth,
                xlabel={attributes / leaf nodes},
                ylabel={milliseconds},
                xmin=0, xmax=32,
    ...
    \begin{subfigure}[h]{0.49\textwidth}
        \begin{tikzpicture}
            \begin{axis}[
                title={Timing of YCT on the laptop},
                width=\textwidth,
                xlabel={attributes / leaf nodes},
                ylabel={milliseconds},
                xmin=0, xmax=32,
        ...
        \end{tikzpicture}
    \end{subfigure} 
    \caption[Timings of the ABE schemes on the SoC and laptop]{Timings of ABE operations on the SoC and on the laptop. Note the different scales between the SoC and the laptop (seconds vs. milliseconds!)}
